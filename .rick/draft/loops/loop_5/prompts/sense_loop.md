...
本次会话目录：/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_5
think subagent：`/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_5/prompts/think.md`
research subagent：`/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_5/prompts/research.md`
exporter subagent：`/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_5/prompts/exporter.md`
最大重试次数：5
反向回流上限：3
...
1. **主题**:端到端验证测试
2. **草稿路径**:/workdir/sunquan20/AI_CODING/rick/.rick/draft | rfc:/workdir/sunquan20/AI_CODING/rick/.rick/draft/rfc | 本次会话:/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_5
...
阶段:[S/E/N1/N2/S-R/EC]
主题:端到端验证测试
草稿:/workdir/sunquan20/AI_CODING/rick/.rick/draft | rfc:/workdir/sunquan20/AI_CODING/rick/.rick/draft/rfc | 会话:/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_5
...
**4. 记录**:
- human 判断原话加入前序上下文
- 通知 subagent 将本阶段简报写入 `/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_5/briefs/[阶段名].md`
- 通知 subagent 将 human 判断原话写入 `/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_5/judgment.md`:`## [阶段] human 判断 — [时间戳]` + human 原话,**禁止写 AI 推理**
