...
主题：继续当前的 loop2 未思考完的问题继续，推进 sense 思考过程
草稿：/workdir/sunquan20/AICODING/rick/.rick/draft | rfc：/workdir/sunquan20/AICODING/rick/.rick/draft/rfc
本次会话目录：/workdir/sunquan20/AICODING/rick/.rick/draft/loops/loop_4
think subagent：`/workdir/sunquan20/AICODING/rick/.rick/draft/loops/loop_4/prompts/think.md`
research subagent：`/workdir/sunquan20/AICODING/rick/.rick/draft/loops/loop_4/prompts/research.md`
exporter subagent：`/workdir/sunquan20/AICODING/rick/.rick/draft/loops/loop_4/prompts/exporter.md`
最大重试次数：5
反向回流上限：3
...
1. **主题**:继续当前的 loop2 未思考完的问题继续，推进 sense 思考过程
2. **草稿路径**:/workdir/sunquan20/AICODING/rick/.rick/draft | rfc:/workdir/sunquan20/AICODING/rick/.rick/draft/rfc | 本次会话:/workdir/sunquan20/AICODING/rick/.rick/draft/loops/loop_4
...
阶段:[S/E/N1/N2/S-R/EC]
主题:继续当前的 loop2 未思考完的问题继续，推进 sense 思考过程
草稿:/workdir/sunquan20/AICODING/rick/.rick/draft | rfc:/workdir/sunquan20/AICODING/rick/.rick/draft/rfc | 会话:/workdir/sunquan20/AICODING/rick/.rick/draft/loops/loop_4
...
**4. 记录**:
- human 判断原话加入前序上下文
- 通知 subagent 将本阶段简报写入 `/workdir/sunquan20/AICODING/rick/.rick/draft/loops/loop_4/briefs/[阶段名].md`
- 通知 subagent 将 human 判断原话写入 `/workdir/sunquan20/AICODING/rick/.rick/draft/loops/loop_4/judgment.md`:`## [阶段] human 判断 — [时间戳]` + human 原话,**禁止写 AI 推理**
...
1. 派发 exporter subagent:先确认大纲 → human 确认 → 填内容 → 产出 `/workdir/sunquan20/AICODING/rick/.rick/draft/rfc/rfc-[主题]-[日期].md`
2. 展示 rfc 路径,告知完成
