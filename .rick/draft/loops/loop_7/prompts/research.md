...
草稿：/workdir/sunquan20/AI_CODING/rick/.rick/draft | rfc：/workdir/sunquan20/AI_CODING/rick/.rick/draft/rfc | 本次会话：/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_7

**先读**：`/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_7/prompts/skill_research.md`
...
读任务派发,绘制根节点(=主题),按 MECE 划分第一层子节点。创建主报告 `/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_7/briefs/research-report.md`。
...
LOOP:
  ...
  b. 执行叶节点调研（传:节点路径+信源配置+调研动作约束）
     ...
     落盘:/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_7/briefs/research-{N}-{节点路径}.md
...
调研报告写入 `/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_7/briefs/research-{N}-{节点路径}.md`,含:执行动作 / 各信源验证结果 / 还原确认 / 疑问点。

---

## 主报告格式

文件:`/workdir/sunquan20/AI_CODING/rick/.rick/draft/loops/loop_7/briefs/research-report.md`
