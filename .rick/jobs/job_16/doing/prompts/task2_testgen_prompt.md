...
**Task ID**: task2
**Task Name**: 更新 doing.md / plan.md 模板引用，删除 super-debugging-zh.md
**Task Goal**: 将两个提示词模板从 super-debugging 切换到 debug_skill，同时清理 doing.md 中冗余的 debug{N} 记录格式（改为加载 debug_skill），删除已废弃的 super-debugging-zh.md 文件。
...
请创建测试脚本到: `/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_16/doing/tests/task2.py`
...
- 脚本应该可以直接运行: `python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_16/doing/tests/task2.py`
...
```bash
python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_16/doing/tests/task2.py
```
