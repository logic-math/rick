...
**Task ID**: task5
**Task Name**: 迁移 plan prompt builder + plan.md 模板：移除 OKR/SPEC/RFC 路径，注入 loops_context
**Task Goal**: 修改 `internal/prompt/plan_prompt.go` 和 `internal/prompt/templates/plan.md`：
...
请创建测试脚本到: `/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_22/doing/tests/task5.py`
...
- 脚本应该可以直接运行: `python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_22/doing/tests/task5.py`
...
```bash
python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_22/doing/tests/task5.py
```
