...
**Task ID**: task6
**Task Name**: 迁移 learning prompt builder + learning.md 模板：移除 wiki/tools 输出，改写为 loops/skills 产出
**Task Goal**: 修改 `internal/prompt/` 中 learning prompt 相关代码和 `internal/prompt/templates/learning.md`：
...
请创建测试脚本到: `/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_22/doing/tests/task6.py`
...
- 脚本应该可以直接运行: `python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_22/doing/tests/task6.py`
...
```bash
python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_22/doing/tests/task6.py
```
