...
**Task ID**: task7
**Task Name**: 迁移 easy + dream prompt builders + 模板：移除 SPEC/OKR/wiki/tools，注入 loops_context
**Task Goal**: 修改 easy 和 dream 的 prompt builder + 模板，对齐 task4-6 的架构变更：
...
预期输出：0
**easy debug_content 保留验证**（边界用例 - 不该删的别删）：
...
请创建测试脚本到: `/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_22/doing/tests/task7.py`
...
- 脚本应该可以直接运行: `python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_22/doing/tests/task7.py`
...
```bash
python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_22/doing/tests/task7.py
```
