...
**Task ID**: task12
**Task Name**: 三个 O 端到端验收 + README/wiki 文档同步
**Task Goal**: 以用户视角做端到端验收，确认三个 O 全部落地，并同步用户面向文档（README.md + wiki/，不修改 `.rick/domain/`）。
...
请创建测试脚本到: `/workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_35/doing/tests/task12.py`
...
- 脚本应该可以直接运行: `python3 /workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_35/doing/tests/task12.py`
...
```bash
python3 /workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_35/doing/tests/task12.py
```
