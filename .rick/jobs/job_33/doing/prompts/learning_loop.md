...
**成功标准**（全部满足时退出）：
- `/workdir/sunquan20/AI_CODING/rick/bin/rick tools learning_check job_33` pass
- `/workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_33/learning/SUMMARY.md` 已写入，首行 `APPROVED: true`
...
- `/workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_33/learning/SUMMARY.md` — 执行总结
...
读取 `/workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_33/doing/prompts/skill_gen_skill.md`，按其定义的格式（触发场景 / 预期效果 / 核心内容）从 act-path 和 debug 中提取可复用技能：
...
读取 `/workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_33/doing/prompts/skill_gen_loop.md`，从 act-path 和 debug 中识别 job 内反复出现的循环模式，按其定义的完整格式写入 `/workdir/sunquan20/AI_CODING/rick/.rick/loops/{name}-loop.md`：
...
写入 `/workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_33/learning/SUMMARY.md`：
...
**父 Agent 验收**：`/workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_33/learning/SUMMARY.md` 存在，首行为 `APPROVED: true`。
...
```bash
/workdir/sunquan20/AI_CODING/rick/bin/rick tools learning_check job_33
```
...
| SUMMARY.md 存在 | `ls /workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_33/learning/SUMMARY.md` |
...
5. **SUMMARY.md 写入 learning 目录**：`/workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_33/learning/SUMMARY.md`
