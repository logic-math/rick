...
**Task ID**: task2
**Task Name**: 更新 plan.md 模板 + plan_prompt.go：移除 sense 追问，注入 grilling skill
**Task Goal**: 1. 从 `internal/prompt/templates/plan.md` 中删除"三、思考方法"section（sense S→E→N 分析块，约 20 行），删除 `{{sense_skill_path}}` 变量所有引用
...
请创建测试脚本到: `/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_18/doing/tests/task2.py`
...
- 脚本应该可以直接运行: `python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_18/doing/tests/task2.py`
...
```bash
python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_18/doing/tests/task2.py
```
