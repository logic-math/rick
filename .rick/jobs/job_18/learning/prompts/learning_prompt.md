...
### .rick/jobs/job_18/doing/debug/（执行问题记录，已内嵌）
...
- **任务详情**（task*.md）:
  - `/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_18/plan/task1.md`
  - `/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_18/plan/task2.md`
  - `/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_18/plan/task3.md`
  - `/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_18/plan/task4.md`
- **执行轨迹**（act-path.md）:
...
|---------|---------|------|-------------|----------|
| task1 | 创建 grilling skill 文件（templates/skills/grilling.md） | success | 2e515583 | 0 |
| task2 | 更新 plan.md 模板 + plan_prompt.go：移除 sense 追问，注入 grilling skill | success | 6c6b9377 | 0 |
| task3 | 更新 easy.md 模板 + easy_prompt.go：注入 grilling skill，添加 requirement.md 追加指令 | success | e57a46e9 | 0 |
| task4 | 构建验证：build + dry-run 输出检查 + 回归测试 | success | e57a46e9 | 0 |
...
分析上方".rick/jobs/job_18/doing/debug/（执行问题记录）"内容：
- 每个 debug 条目的根因与解决过程
...
技能文件：`/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_18/learning/prompts/skill_gen_skill.md`
...
在 `/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_18/learning` 下生成 `SUMMARY.md`：
...
```bash
/Users/sunquan/ai_coding/CODING/rick/bin/rick tools learning_check job_18
```
...
4. **SUMMARY.md 写入 learning 目录**：`/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_18/learning/SUMMARY.md` 作为本次执行记录
