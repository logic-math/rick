...
- skill:tdd（测试驱动开发）：`/workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_31/doing/prompts/skill_tdd_zh.md`
- skill:testing-anti-patterns（测试反模式）：`/workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_31/doing/prompts/skill_testing_anti_patterns_zh.md`
...
**Task ID**: task1
**Task Name**: 端到端验证任务
**Task Goal**: 验证 rick doing 命令能调用 pi 执行任务
...
请创建测试脚本到: `/workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_31/doing/tests/task1.py`
...
- 脚本应该可以直接运行: `python3 /workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_31/doing/tests/task1.py`
...
```bash
python3 /workdir/sunquan20/AI_CODING/rick/.rick/jobs/job_31/doing/tests/task1.py
```
