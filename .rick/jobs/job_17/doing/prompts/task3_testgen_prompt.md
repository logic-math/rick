...
**Task ID**: task3
**Task Name**: 重构 easy.go 消除内部重复，复用已有 callClaudeCodeCLI
**Task Goal**: `rick doing --easy` 功能完整保留，通过复用已有函数消除 `easy.go` 内的重复实现：
...
请创建测试脚本到: `/Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_17/doing/tests/task3.py`
...
- 脚本应该可以直接运行: `python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_17/doing/tests/task3.py`
...
```bash
python3 /Users/sunquan/ai_coding/CODING/rick/.rick/jobs/job_17/doing/tests/task3.py
```
