...
**任务 ID**: task2
**任务名称**: 提取公共 frontmatter 解析函数到 internal/parser 包
...
### 测试方法
**parser.ExtractBugFrontmatter 正常解析**
...
**easy_prompt.go 内联解析已替换，parser import 已添加**
...
```
=== Attempt 1 ===
test did not pass: internal/parser/frontmatter.go does not exist: /Users/sunquan/ai_coding/CODING/rick/internal/parser/frontmatter.go; internal/parser/frontmatter_test.go does not exist: /Users/sunquan/ai_coding/CODING/rick/internal/parser/frontmatter_test.go; easy_prompt.go still contains inline frontmatter parsing (HasPrefix summary/status); easy_prompt.go missing import of internal/parser package

Full test output:
{"pass": false, "errors": ["internal/parser/frontmatter.go does not exist: /Users/sunquan/ai_coding/CODING/rick/internal/parser/frontmatter.go", "internal/parser/frontmatter_test.go does not exist: /Users/sunquan/ai_coding/CODING/rick/internal/parser/frontmatter_test.go", "easy_prompt.go still contains inline frontmatter parsing (HasPrefix summary/status)", "easy_prompt.go missing import of internal/parser package"]}

STDERR:
[DEBUG] project_root: /Users/sunquan/ai_coding/CODING/rick
[DEBUG] go test stdout: ok  	github.com/sunquan/rick/internal/executor	1.366s
ok  	github.com/sunquan/rick/internal/parser	(cached)

[DEBUG] go test stderr: 
